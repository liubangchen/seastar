...
find_library (dpdk_PMD_VMXNET3_UIO_LIBRARY rte_pmd_vmxnet3_uio PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_I40E_LIBRARY rte_pmd_i40e PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_IXGBE_LIBRARY rte_pmd_ixgbe PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_E1000_LIBRARY rte_pmd_e1000 PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_BNXT_LIBRARY rte_pmd_bnxt PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_RING_LIBRARY rte_pmd_ring PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_CXGBE_LIBRARY rte_pmd_cxgbe PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_ENA_LIBRARY rte_pmd_ena PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_ENIC_LIBRARY rte_pmd_enic PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_FM10K_LIBRARY rte_pmd_fm10k PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_NFP_LIBRARY rte_pmd_nfp PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_QEDE_LIBRARY rte_pmd_qede PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_RING_LIBRARY rte_ring PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_KVARGS_LIBRARY rte_kvargs PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_MEMPOOL_LIBRARY rte_mempool PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_MEMPOOL_RING_LIBRARY rte_mempool_ring PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PMD_SFC_EFX_LIBRARY rte_pmd_sfc_efx PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_HASH_LIBRARY rte_hash PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_CMDLINE_LIBRARY rte_cmdline PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_MBUF_LIBRARY rte_mbuf PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_CFGFILE_LIBRARY rte_cfgfile PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_EAL_LIBRARY rte_eal PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_ETHDEV_LIBRARY rte_ethdev PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_NET_LIBRARY rte_net PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_TIMER_LIBRARY rte_timer PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_PCI_LIBRARY rte_pci PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_BUS_PCI_LIBRARY rte_bus_pci PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
find_library (dpdk_BUS_VDEV_LIBRARY rte_bus_vdev PATHS ${CMAKE_CURRENT_SOURCE_DIR}/contrib/dpdk/lib)
